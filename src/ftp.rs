...
impl FtpStream {
    ...
    /// Retrieves the file name specified from the server. This method is a more complicated way to
    /// retrieve a file. The reader returned should be dropped.  Also you will have to read the
    /// response to make sure it has the correct value.
